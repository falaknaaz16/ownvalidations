...
<head>
    ...
    <link rel="stylesheet" href="myvalidation/dist/css/bootstrapValidator.css"/>

    <script type="text/javascript" src="myvalidation/vendor/jquery/jquery-1.10.2.min.js"></script>
    <script type="text/javascript" src="myvalidation/vendor/bootstrap/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="myvalidation/dist/js/bootstrapValidator.js"></script>
</head>
